...
xlabel('rozmiar');
ylabel('błąd');
title('wartości współczynników wielomianu, gdy wektor b zawiera wartości funkcji liniowej');
...
xlabel('rozmiar');
ylabel('błąd');
title('wartości współczynników wielomianu, gdy wektor b zawiera zaburzone wartości funkcji liniowej');
