...
F_coarse = sin(2*pi*X_coarse).*cos(2*pi*Y_coarse); % zadanie A: zmień definicję funkcji interpolowanej
...
% wybranie odpowiedniego wspolczynnika z wektora kolumnowego
% w pierwszej iteracji elementy F_fine beda mialy wartosc 1*coeffs(0)
% w nastepnych iteracjach beda dodawane kolejne wspolczynniki wielomianu
for i = 0:(M-1)
    for j = 0:(N-1)
